package com.board.boardExample.Controller;

import com.board.boardExample.domain.Board;
import com.board.boardExample.service.BoardService;
...
public class BoardController {
    ...
    public String viewBoard(Model model, Long boardId) {
        ...
        model.addAttribute("contentView", service.getBoard(boardId));
    ...
    public String uploadBoard(Board board) {
        ...
        return "redirect:/board/main"; // ディレクトリではなくURL（アップロードが終わるとメイン画面に戻る）
    }
